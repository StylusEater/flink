...
import org.apache.flink.javascript.api.JavaScriptPlanBinder.Operation;
import org.apache.flink.javascript.api.streaming.Receiver;

public class JavaScriptOperationInfo {
	...
	public JavaScriptOperationInfo(Receiver receiver, Operation identifier) throws IOException {
		Object tmpType;
		switch (identifier) {
			case SOURCE_CSV:
		...
		switch (identifier) {
			...
			case FILTER:
				...
				return;
			default:
				throw new UnsupportedOperationException("This operation is not implemented in the JavaScript API: " + identifier);
		}
	}
